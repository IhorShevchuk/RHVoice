...
let package = Package(
    ...
    targets: [
        .target(
            ...
            path:"src/",
            exclude:[
                "apple", // This is built in scope of 'RHVoice' target of current package
        ...
        .executableTarget(
            ...
            path: "src/apple/Package/Plugins/PackDataExecutable"
        ),
        .plugin(name: "PackDataPlugin",
                ...
                path: "src/apple/Package/Plugins/PackData",
                sources: [
